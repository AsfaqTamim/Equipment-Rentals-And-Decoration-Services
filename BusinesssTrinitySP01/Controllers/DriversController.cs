...
namespace BusinesssTrinitySP01.Controllers
{
    ...
    public class DriversController : Controller
    {
        ...
        public ActionResult FinishDelivery(int id)
        {
            ...
            string url = "<a href=" + "https://trinityrentals.azurewebsites.net/Home/Confirmation/" + id + " >  here" + "</a>";
            var order = db.orders.Find(id);
        ...
        public ActionResult InspectionReport(int id)
        {
            ...
            if (missingCost + DCost > 300)
            {
                ...
                ViewBag.Owing = owing.ToString("R0.00");
                ViewBag.RDeposit = RDeposit.ToString("R0.00");
