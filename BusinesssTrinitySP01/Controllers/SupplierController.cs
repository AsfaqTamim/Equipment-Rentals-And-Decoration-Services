    ...
    public class SupplierController : Controller
    {
        ...
        public ActionResult QuoteReport(int? id)
        {
            ...
            else
            {
                ...
                string url = "https://trinityrentals.azurewebsites.net/Home/PrintPartialViewToPdf/" + quote.QuoteID;
                if (quote != null)
                {
        ...
        public ActionResult ConfirmInvoice(Request request)
        {
            ...
            string url = "https://trinityrentals.azurewebsites.net/Home/ViewInvoice" + quote.RequestID;
            var client = new SendGridClient("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");
            var from = new EmailAddress("nkonzo144@gmail.com", "Trinity Pty(Ltd)");
